  ...
  <div class="col-md-4">
    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
      <div class="col-auto d-none d-lg-block">
        ...
        width="200" height="250" alt="" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
      ...
      <div class="col p-4 d-flex flex-column position-static">
        ...
        <div class="mb-1 text-muted">{{ new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(product.price) }}</div>
        <p class="card-text mb-auto">Stock: {{ product.stock }} pcs</p>
        <div class="btn-group btn-group-sm" role="group" aria-label="Basic outlined example">
          <button @click.prevent="addToCart" type="button" class="btn btn-primary">
