            ...
            <div class="row">
              <div class="col-md-9 col-lg-8 mx-auto">
                ...
                <form @submit.prevent="register">
                  ...
                  />
                  <button
                    class="btn btn-sm btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2"
                    type="submit"
                  >
                    Register
                  </button>
                  <button
                  @click="toLogin"
                    class="btn btn-sm btn-warning btn-block btn-login text-uppercase font-weight-bold mb-2"
                    type="button"
                  >
                    login using Account
                  </button>
